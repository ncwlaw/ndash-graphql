...
const latestBuilds = async (context) => {
  const format = (() => {
    ...
    const projectLens = R.compose(R.lensProp("by_namespace"), bucketLens);
    const componentLens = R.compose(R.lensProp("by_component"), bucketLens);
